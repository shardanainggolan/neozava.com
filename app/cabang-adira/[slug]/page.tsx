...
async function getBranch(slug: string): Promise<Branch | null> {
  const res = await fetch(
    `https://backend.neozava.com/api/branch/slug/${slug}`,
...
function InfoCard({
  ...
  return (
    <div className="flex-1 bg-white rounded-2xl border border-gray-100 p-4! text-center flex flex-col items-center gap-2!">
      <div className="w-12! h-12! rounded-2xl bg-[#fdf0f0] flex items-center justify-center text-[#9a0000]">
        {icon}
      </div>
...
function WaButton({
  ...
  return (
    <a
      ...
      className="w-full flex items-center justify-center gap-2! py-3! rounded-full bg-[#9a0000] text-white text-[13px] font-bold active:scale-95 transition-transform"
    >
    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="bg-[#9a0000] px-5! pt-5! pb-5!">
        ...
        <div className="flex items-center gap-1.5 text-[11px] text-red-200 mb-3! flex-wrap">
          ...
          <span>/</span>
          <span className="text-white font-medium truncate max-w-[160px]">{branch.name}</span>
        </div>
        {/* Title */}
      ...
      <main className="flex-1 flex flex-col bg-[#f6f6f6]">
        ...
        <div className="bg-white px-5! py-6! flex flex-col gap-4!">
          ...
          <div className="bg-gray-50 rounded-2xl border border-gray-100 p-4! flex flex-col items-center text-center gap-3!">
            ...
            <WaButton
              wa={WA_DEFAULT}
              text="Halo saya ingin mengajukan gadai BPKB"
          ...
          <div className="bg-gray-50 rounded-2xl border border-gray-100 p-4! flex flex-col items-center text-center gap-3!">
            ...
            <div>
              <h2 className="text-[15px] font-extrabold text-gray-900 mb-1!">Kredit Motor Baru/Bekas</h2>
              <p className="text-[12px] text-[#646464] leading-relaxed">
            ...
            <WaButton
              wa={WA_DEFAULT}
              text="Halo saya ingin mengajukan Kredit Motor"
              label="Ajukan Sekarang"
            />
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl border border-gray-100 p-4! flex flex-col items-center text-center gap-3!">
            <span className="text-4xl">🚙</span>
            <div>
              <h2 className="text-[15px] font-extrabold text-gray-900 mb-1!">Kredit Mobil Baru/Bekas</h2>
              <p className="text-[12px] text-[#646464] leading-relaxed">
